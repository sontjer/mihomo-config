...
Update_Shell() {
    ...
    # 获取最新版本号
    sh_ver_url="https://gh-proxy.com/https://raw.githubusercontent.com/Abcd789JK/Tools/main/Script/mihomo/mihomocdn.sh"
...
Install() {
    ...
    bash <(curl -Ls https://gh-proxy.com/https://raw.githubusercontent.com/Abcd789JK/Tools/main/Script/mihomo/installcdn.sh)
}
